...
class Model_OBV24T000974AX17644(BaseModel):
    ...
    LAW_PROC_RESULT_CD: Union[str, int, float, None] = Field(
        None, description="법사위처리결과", alias="LAW_PROC_RESULT_CD"
    )
...
class Model_ODFFIG001072OX10139(BaseModel):
    ...
    COMMITTEE_SUBMIT_DT: Union[str, int, float, None] = Field(
        None, description="위원회심사_회부일", alias="COMMITTEE_SUBMIT_DT"
    )
    COMMITTEE_PRESENT_DT: Union[str, int, float, None] = Field(
        None, description="위원회심사_상정일", alias="COMMITTEE_PRESENT_DT"
    )
    COMMITTEE_PROC_DT: Union[str, int, float, None] = Field(
        None, description="위원회심사_의결일", alias="COMMITTEE_PROC_DT"
    )
...
class Model_OXN4AR0009078I18280(BaseModel):
    ...
    CLSD_RSON: Union[str, int, float, None] = Field(
        None, description="결정내용>비공개(부분공개) 내용 및 사유", alias="CLSD_RSON"
    )
...
class Model_OM5S9O0009857U12121(BaseModel):
    ...
    LAW_PRESENT_DT: Union[str, int, float, None] = Field(None, description="법사위상정일", alias="LAW_PRESENT_DT")
    LAW_PROC_DT: Union[str, int, float, None] = Field(None, description="법사위처리일", alias="LAW_PROC_DT")
    CMT_PROC_RESULT_CD: Union[str, int, float, None] = Field(
        None, description="소관위처리결과", alias="CMT_PROC_RESULT_CD"
    )
    LAW_PROC_RESULT_CD: Union[str, int, float, None] = Field(
        None, description="법사위처리결과", alias="LAW_PROC_RESULT_CD"
    )
...
class Model_OOWY4R001216HX11493(BaseModel):
    ...
    LWCMIT_CONF_RSLT: Union[str, int, float, None] = Field(
        None, description="법사위 회의결과", alias="LWCMIT_CONF_RSLT"
    )
...
class Model_OEQ77R000942NL11530(BaseModel):
    ...
    REPORT_CLASSIFICATION_NM: Union[str, int, float, None] = Field(
        None, description="보고서분류", alias="REPORT_CLASSIFICATION_NM"
    )
...
class Model_OOWY4R001216HX11439(BaseModel):
    ...
    NAAS_EMAIL_ADDR: Union[str, int, float, None] = Field(
        None, description="국회의원이메일주소", alias="NAAS_EMAIL_ADDR"
    )
...
class Model_OOWY4R001216HX11421(BaseModel):
    ...
    OVER_CLAW_MIS_CNT: Union[str, int, float, None] = Field(
        None, description="헌법 불일치 개정시한 경과 개수", alias="OVER_CLAW_MIS_CNT"
    )
...
class Model_OQX4LR0011965K19194(BaseModel):
    """Response model for OQX4LR0011965K19194"""

    TITLE: Union[str, int, float, None] = Field(None, description="제목", alias="TITLE")
    WRITER: Union[str, int, float, None] = Field(None, description="저자", alias="WRITER")
    PUBLISHER: Union[str, int, float, None] = Field(None, description="출판사", alias="PUBLISHER")
    REG_DTTM: Union[str, int, float, None] = Field(None, description="발간일", alias="REG_DTTM")
    DETAIL_URL: Union[str, int, float, None] = Field(None, description="상세 URL", alias="DETAIL_URL")


class Params_OQX4LR0011965K19194(BaseModel):
    """Request parameters for OQX4LR0011965K19194"""
...
class Model_O5VQRK0008587911609(BaseModel):
    ...
    POLICY_RESRCH_ATM: Union[str, int, float, None] = Field(
        None, description="정책연구비(원)", alias="POLICY_RESRCH_ATM"
    )
...
class Model_O8D9RF000933S512258(BaseModel):
    ...
    THISM_AGGR_EP_AMT: Union[str, int, float, None] = Field(
        None, description="연간누계지출금액", alias="THISM_AGGR_EP_AMT"
    )
    THISM_AGGR_EP_NAMT: Union[str, int, float, None] = Field(
        None, description="당월누계지출순계금액", alias="THISM_AGGR_EP_NAMT"
    )
...
class Model_OOWY4R001216HX11473(BaseModel):
    ...
    LGSLB_ASBLM_PRPSR_CNT: Union[str, int, float, None] = Field(
        None, description="법률안의원발의건수", alias="LGSLB_ASBLM_PRPSR_CNT"
    )
    LGSLB_GVRN_PRPSR_CNT: Union[str, int, float, None] = Field(
        None, description="법률안정부발의건수", alias="LGSLB_GVRN_PRPSR_CNT"
    )
    ...
    RSLNB_ADIT_REQ_CNT: Union[str, int, float, None] = Field(
        None, description="결의안 감사요구 건수", alias="RSLNB_ADIT_REQ_CNT"
    )
    ...
    CMTM_QLF_INSC_CNT: Union[str, int, float, None] = Field(
        None, description="의원자격심사 건수", alias="CMTM_QLF_INSC_CNT"
    )
...
class Model_OOWY4R001216HX11462(BaseModel):
    ...
    JRCMIT_PRSNT_DT: Union[str, int, float, None] = Field(
        None, description="소관위원회 상정일", alias="JRCMIT_PRSNT_DT"
    )
    JRCMIT_PROC_DT: Union[str, int, float, None] = Field(None, description="소관위원회 처리일", alias="JRCMIT_PROC_DT")
    JRCMIT_PROC_RSLT: Union[str, int, float, None] = Field(
        None, description="소관위원회 처리결과", alias="JRCMIT_PROC_RSLT"
    )
    LINK_URL: Union[str, int, float, None] = Field(None, description="링크URL", alias="LINK_URL")
...
class Model_O4K6HM0012064I15889(BaseModel):
    ...
    COMMITTEE_DT: Union[str, int, float, None] = Field(None, description="소관위회부일", alias="COMMITTEE_DT")
    COMMITTEE_PROC_DT: Union[str, int, float, None] = Field(
        None, description="위원회심사_처리일", alias="COMMITTEE_PROC_DT"
    )
    LINK_URL: Union[str, int, float, None] = Field(None, description="의안상세정보_URL", alias="LINK_URL")
    RST_PROPOSER: Union[str, int, float, None] = Field(None, description="대표발의자", alias="RST_PROPOSER")
    LAW_PROC_RESULT_CD: Union[str, int, float, None] = Field(
...
class Model_O87UNV000897E818234(BaseModel):
    ...
    EXPNS_SUPPT_INST_NM: Union[str, int, float, None] = Field(
        None, description="경비지원기관", alias="EXPNS_SUPPT_INST_NM"
    )
...
class Model_OOWY4R001216HX11422(BaseModel):
    ...
    REV_LAW_SITU_TTLL: Union[str, int, float, None] = Field(
        None, description="개정대상법률현황제목", alias="REV_LAW_SITU_TTLL"
    )
    WRT_DT: Union[str, int, float, None] = Field(None, description="작성일자", alias="WRT_DT")
    LINK_URL: Union[str, int, float, None] = Field(None, description="링크 URL", alias="LINK_URL")
...
class Model_OT5EH10012030D12149(BaseModel):
    """Response model for OT5EH10012030D12149"""
...
class Params_OT5EH10012030D12149(BaseModel):
    """Request parameters for OT5EH10012030D12149"""
...
class Model_OOWY4R001216HX11442(BaseModel):
    ...
    FR_LAW_REV_TTL: Union[str, int, float, None] = Field(
        None, description="해외주요법률 제개정 제목", alias="FR_LAW_REV_TTL"
    )
    WRT_NM: Union[str, int, float, None] = Field(None, description="작성자", alias="WRT_NM")
    WRT_DT: Union[str, int, float, None] = Field(None, description="작성일자", alias="WRT_DT")
    LINK_URL: Union[str, int, float, None] = Field(None, description="링크URL", alias="LINK_URL")
...
class Model_OOWY4R001216HX11492(BaseModel):
    ...
    PPSR: Union[str, int, float, None] = Field(None, description="제안자", alias="PPSR")
    PPSL_DT: Union[str, int, float, None] = Field(None, description="제안일", alias="PPSL_DT")
    JRCMIT_CONF_NM: Union[str, int, float, None] = Field(
        None, description="소관위원회 심사 회의명", alias="JRCMIT_CONF_NM"
    )
    JRCMIT_CONF_DT: Union[str, int, float, None] = Field(
        None, description="소관위원회 심사 회의일", alias="JRCMIT_CONF_DT"
    )
    JRCMIT_CONF_RSLT: Union[str, int, float, None] = Field(
        None, description="소관위원회 심사 회의결과", alias="JRCMIT_CONF_RSLT"
    )
...
class Model_O1K5F2001204LJ11992(BaseModel):
    """Response model for O1K5F2001204LJ11992"""
...
class Params_O1K5F2001204LJ11992(BaseModel):
    """Request parameters for O1K5F2001204LJ11992"""
...
class Model_OOWY4R001216HX11440(BaseModel):
    ...
    LAW_CMMT_DT: Union[str, int, float, None] = Field(
        None, description="법사위 체계자구심사 회부일", alias="LAW_CMMT_DT"
    )
    LAW_PRSNT_DT: Union[str, int, float, None] = Field(
        None, description="법사위 체계자구심사 상정일", alias="LAW_PRSNT_DT"
    )
    LAW_PROC_DT: Union[str, int, float, None] = Field(
        None, description="법사위 체계자구심사 처리일", alias="LAW_PROC_DT"
    )
    LAW_PROC_RSLT: Union[str, int, float, None] = Field(
        None, description="법사위 체계자구심사 처리결과", alias="LAW_PROC_RSLT"
    )
    RGS_PRSNT_DT: Union[str, int, float, None] = Field(None, description="본회의 심의 상정일", alias="RGS_PRSNT_DT")
    RGS_RSLN_DT: Union[str, int, float, None] = Field(None, description="본회의 심의 의결일", alias="RGS_RSLN_DT")
...
class Model_OQ68B8001071ZB13418(BaseModel):
    ...
    LAW_SUBMIT_DT: Union[str, int, float, None] = Field(
        None, description="법사위체계자구심사_회부일", alias="LAW_SUBMIT_DT"
    )
    LAW_PRESENT_DT: Union[str, int, float, None] = Field(
        None, description="법사위체계자구심사_상정일", alias="LAW_PRESENT_DT"
    )
    LAW_PROC_DT: Union[str, int, float, None] = Field(
        None, description="법사위체계자구심사_의결일", alias="LAW_PROC_DT"
    )
    RGS_PRESENT_DT: Union[str, int, float, None] = Field(None, description="본회의심의_상정일", alias="RGS_PRESENT_DT")
    RGS_PROC_DT: Union[str, int, float, None] = Field(None, description="본회의심의_의결일", alias="RGS_PROC_DT")
    CURR_TRANS_DT: Union[str, int, float, None] = Field(None, description="정부이송일", alias="CURR_TRANS_DT")
...
class Model_O9RY2V0011518716129(BaseModel):
    ...
    NATION_FMLAWMKCT: Union[str, int, float, None] = Field(
        None, description="전국구여성의원수", alias="NATION_FMLAWMKCT"
    )
    NATION_FMLAWMKNM: Union[str, int, float, None] = Field(
        None, description="전국구여성의원명", alias="NATION_FMLAWMKNM"
    )
    SUM: Union[str, int, float, None] = Field(None, description="합계", alias="SUM")
    RMK: Union[str, int, float, None] = Field(None, description="비고", alias="RMK")
